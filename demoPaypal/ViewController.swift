...
class ViewController: UIViewController ,UITextFieldDelegate {
	...
	override func viewDidLoad() {
		super.viewDidLoad()
		addLabelWithText("Simple Payment", type:BUTTON_294x43, action: #selector(ViewController.simplePayment))
		addLabelWithText("Parallel Payment", type:BUTTON_294x43, action: #selector(ViewController.parallelPayment))
		addLabelWithText("Chained Payment", type:BUTTON_294x43, action: #selector(ViewController.chainedPayment))
		addLabelWithText("Preapproval", type:BUTTON_294x43, action: #selector(ViewController.Preapproval))
	...
	func simplePayment(){
		...
		payment.recipient = "amitmerchant@chetu.com"
	...
	func parallelPayment(){
		...
		for index in 0...2 {
			...
			details.recipient = "amitmer\(index + 1)@chetu.com"
